        ...
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-md-12 adj1 text-center">
            ...
            <p>
              ...
              longer do the countries of the world have to settle disputes with
              needless expenditure of human life. Now wars can be fought and won
              by value of your Globomantics Mark 1 upgrade selections. More than
              any other time in history, wars will be won by the willingness to
              spend rather than the strength of will of the individual.
            </p>
